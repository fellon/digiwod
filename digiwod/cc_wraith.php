...
?>
You are creating a Wraith. If this is not what you want to do please <a href="portal.php">click here</a>. <br>
	...
	<form method="post" action="do_addwerewolf.php">
        <table width="100%">
          ...
          <tr> 
            ...
            <td colspan="4"> <select name="life" id="select30">
                <option selected>--Select--</option>
          ...
          <tr> 
            ...
            <td colspan="4">Regret: </td>
          </tr>
          <tr> 
            <td height="25" colspan="2"><select name="death" id="death">
                <option selected>--Select--</option>
                <option value="Homid">Homid</option>
                <option value="Metis">Metis</option>
                <option value="Lupus">Lupus</option>
              </select></td>
            <td colspan="4"><select name="regret" id="regret">
                <option selected>--Select--</option>
          ...
          <tr> 
            <td colspan="2">Shadow Archtype : </td>
            <td colspan="4">Pack Totem: </td>
          </tr>
          <tr> 
            <td colspan="2"><input name="shadow" type="text" id="shadow"></td>
