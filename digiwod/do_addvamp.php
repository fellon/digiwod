...
include_once("striper.inc.php");
	...
	if ($num_rows >= 1)
	{
 	...
 	if ($amiused == 'true') 
 		{
		header( "Location: http://www.willowhaven.org/willowchat/cc_vamp.php");
		exit;
	 	}
  $query="INSERT INTO characters (charname, playerid, player, venue) VALUES ('$_POST[charname]','$uid','$username','Vampire')";
