...
?>
You are creating a Vampire. If this is not what you want to do please <a href="portal.php">click here</a>. For the name field please use only Alpha numeric ( A - Z : 0 - 1 ) characters along with the Underscore ( _ ) character.<br>
...
<form method="post" action="do_addvamp.php">
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td colspan="2">
              <input name="charname" type="text" id="charname" size="25"></td>
            <td colspan="4">
              <input name="charage" type="text" id="charage" size="5"></td>
          </tr>
          <tr>
            <td colspan="2">Character Gender: * </td>
            <td colspan="4">Clan: * </td>
          </tr>
          <tr>
            <td colspan="2">
          ...
          <tr>
            ...
            <td colspan="4">
              <input name="demeanor" type="text" id="demeanor2"></td>
          </tr>
          <tr>
            <td colspan="6">Background Story: (This is extremly important) </td>
          </tr>
          <tr>
            <td colspan="6"><textarea name="bgstory" cols="60" rows="10" id="bgstory"></textarea></td>
          </tr>
          <tr>
          ...
          <tr>
            <td colspan="6"><div align="left">
                <textarea name="description" cols="60" id="description">A brief description of your character</textarea>
            </div></td>
          </tr>
          <tr>
          ...
          <tr>
            <td colspan="6">
              <input name="concept" type="text" value="Short, short, concept." size="40" maxlength="40">
          ...
          <tr>
            <td colspan="6">
              <input name="exitmsg" type="text" id="exitmsg6" value="My exit message" size="60">
            </td>
          </tr>
          <tr>
...
<div align="left"></div></td>
      ...
      Yes! </td>
          ...
          <tr>
            <td colspan="6">Choosing yes means you do not need a view-only password </td>
          </tr>
          <tr>
          ...
          <tr>
            <td>
              <input name="supernat7" type="text" id="supernat7" size="15"></td>
          ...
          <tr>
            <td colspan="6">
              <input name="flaws" type="text" id="flaws" size="93"></td>
          </tr>
          <tr>
            <td colspan="2">&nbsp;</td>
            <td colspan="2">&nbsp;</td>
          ...
          <tr>
            <td colspan="2">
              <input name="path" type="text" id="path2" size="20">
            </td>
            <td colspan="4">
          ...
          <tr>
            <td colspan="6">
              <input name="misc" type="text" id="misc2" size="93"></td>
          </tr>
          <tr>
            <td colspan="6">
                <div align="right">
                    <input type="submit" name="Submit" value="Submit Vampire Character">
                </div></td></tr>
        </table>
</form><?php
