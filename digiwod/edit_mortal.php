...
<input name="venue" type="hidden" value="Mortal">
<input name="iamediting" type="hidden" id="iamediting" value="<?php echo $_POST[iamediting]; ?>">
        <table width="100%">
          ...
          <tr> 
            <td colspan="2"> <input name="charname" type="text" id="charname" value="<?php echo $charname; ?>" size="25"></td>
            <td colspan="4"> <input name="charage" type="text" id="charage" value="<?php echo $charage; ?>" size="5"></td>
          </tr>
          <tr> 
...
<?php } ?>
          ...
          <tr> 
            <td colspan="2"><p> 
                <input name="nature" type="text" value="<?php echo $nature; ?>" id="nature">
              </p></td>
            <td colspan="4"> <input name="demeanor" type="text" value="<?php echo $demeanor; ?>" id="demeanor2"></td>
          </tr>
          <tr> 
          ...
          <tr> 
            <td colspan="6"><div align="left"> 
                <textarea name="description" cols="60" id="textarea2"><?php echo $description; ?></textarea>
</div></td>
          </tr>
          <tr> 
          ...
          <tr> 
            <td colspan="6"> <input name="concept" type="text" value="<?php echo $concept; ?>" size="40" maxlength="40"> 
          ...
          <tr> 
            <td colspan="6"> <input name="exitmsg" type="text" id="exitmsg6" value="<?php echo $exitmsg; ?>" size="60"> 
            </td>
          </tr>
          <tr>
		...
		?>
		<input name="experience2" type="hidden" id="experience2" value="<?php echo $experience; ?>">
		...
		?></td>
          ...
          <tr>
            <td height="27" colspan="6"><div align="center"><strong>Abilities</strong></div></td>
          </tr>
          <tr>
          ...
          <tr> 
            ...
            <td colspan="2"><input name="meritstotal" type="text" value="<?php echo $meritstotal; ?>" id="meritstotal" size="5"></td>
          </tr>
          <tr> 
          ...
          <tr> 
            ...
            <td colspan="2">Total:</td>
            <td colspan="2"><input name="flawstotal" type="text" value="<?php echo $flawstotal; ?>" id="flawstotal" size="5"></td>
          </tr>
          <tr> 
            <td colspan="6"> <input name="flaws" type="text" value="<?php echo $flaws; ?>" id="flaws2" size="93"></td>
          </tr>
          <tr> 
            <td colspan="2">&nbsp;</td>
            <td colspan="2">&nbsp;</td>
			...
			<table width="100%" border="0" align="center">
                <tr> 
                  ...
                  <td><select name="virtcc" id="select84">
                    ...
                    <option value="4">4</option>
                    <option value="5">5</option>
                    <option value="<?php echo $virtcc; ?>" selected><?php echo $virtcc; ?></option>
                    </select></td>
                  ...
                  <td><select name="virtc" id="select86">
                    ...
                    <option value="4">4</option>
                    <option value="5">5</option>
                    <option value="<?php echo $virtc; ?>" selected><?php echo $virtc; ?></option>
                    </select></td>
                </tr>
              </table>
			  </td>
          ...
          <tr> 
            <td colspan="2"> <input name="path" type="text" value="<?php echo $path; ?>" id="path2" size="20"></td>
            <td colspan="4"> <select name="pathrate" id="select87">
              <option value="1">1</option>
              <option value="2">2</option>
              <option value="3">3</option>
              <option value="4">4</option>
              ...
              <option value="9">9</option>
              <option value="10">10</option>
              <option value="<?php echo $pathrate; ?>" selected><?php echo $pathrate; ?></option>
              </select> </td>
          </tr>
          <tr> 
          ...
          <tr> 
            <td colspan="2"> <select name="willpowerperm" id="willpowerperm">
            ...
            <td colspan="4"> <select name="willpowertemp" id="willpowertemp">
              <option value="0">0</option>
              <option value="1">1</option>
              <option value="2">2</option>
              <option value="3">3</option>
          ...
          <tr> 
            <td colspan="6"><input name="equipment" type="text" value="<?php echo $equipment; ?>" id="equipment" size="93"></td>
          </tr>
          <tr>
            <td colspan="6">Equipment off Character: </td>
          </tr>
          <tr>
            <td colspan="6"><input name="equiphome" type="text" id="equiphome4" value="<?php echo $equiphome; ?>" size="93"></td>
          </tr>
          <tr> 
            <td colspan="6">Misc:</td>
          </tr>
          <tr> 
            <td colspan="6"> <input name="misc" type="text" value="<?php echo $misc; ?>" id="misc2" size="93"></td>
          </tr>
          <tr> 
            <td colspan="3"><div align="center"> 
                <input type="submit" name="Submit" value="Update Mortal">
              </div></td>
