...
?>
        <table width="100%"  border="1">
          ...
          <tr>
            <td colspan="2"><?php echo $concept; ?></td>
          </tr>
      </table>
        <?php
	...
	?>        
        <table width="100%" border="1">
          <tr>
            ...
            <td colspan="4"><strong><em>Clan</em></strong>:
              <?php echo $clan; ?></td>
          </tr>
          <tr>
            <td colspan="2">
          ...
          <tr>
            <td colspan="2"><strong><em>Generation</em></strong>:</td>
            <td colspan="4"><strong><em>Sect</em></strong>:</td>
          </tr>
          <tr>
            <td colspan="2"><?php echo $generation; ?></td>
            <td colspan="4"><?php echo $sect; ?></td>
          </tr>
          <tr>
...
&nbsp;</td>
          ...
          <tr>
            ...
            <td colspan="2"><strong><em>Total Merits</em></strong>:</td>
          ...
          <tr>
            ...
            <td colspan="2"><strong><em>Total Flaws</em></strong>:</td>
          ...
          <tr>
            <td colspan="6"><table width="100%" border="0" align="center">
                <tr>
                  <td><strong><em>Conscience/Conviction</em></strong>:</td>
                  <td><?php echo $virtcc; ?></td>
                  <td><strong><em>Self-Control/Instinct</em></strong>:</td>
                  <td><?php echo $virtsci; ?></td>
                  <td><em><strong>Courage</strong></em>: </td>
                  <td><?php echo $virtc; ?></td>
                </tr>
            </table></td>
          </tr>
          <tr>
          ...
          <tr>
            <td colspan="2"><strong><em>Humanity/Path</em></strong>:</td>
            <td colspan="4"><strong><em>Path Rating</em></strong>: </td>
          </tr>
          <tr>
            <td colspan="2">
              <?php echo $path; ?></td>
          ...
          <tr>
            <td colspan="2"><strong><em>Willpower Permanent</em></strong> :</td>
            <td colspan="4"><strong><em>Willpower Temporary</em></strong>:</td>
          </tr>
          <tr>
            <td colspan="2">
