...
?>
You are creating a Mortal Character. If this is not what you want to do please <a href="portal.php">click here</a>.<br>
...
* denotes fields that are required. Attempting to save a character that is not complete will reload the creation page with all blank fields. You are warned.</em>
	<form method="post" action="do_addmortal.php">
        <table width="100%">
          <tr> 
          ...
          <tr> 
            <td colspan="2"> <input name="path" type="text" id="path2" value="Humanity" size="20"></td>
          ...
          <tr> 
            <td colspan="6"><div align="center"> 
                <input type="submit" name="Submit" value="Submit Mortal Character">
              </div></td>
          </tr>
        </table>
      </form><?php
