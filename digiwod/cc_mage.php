...
?>
You are creating a Mage Character. If this is not what you want to do please <a href="portal.php">click here</a>.<br>
...
* denotes fields that are required. Attempting to save a character that is not complete will reload the creation page with all blank fields. You are warned.</em> <br>
	...
	<form method="post" action="do_addmage.php">
        <table width="100%">
          <tr> 
          ...
          <tr> 
            ...
            <td colspan="4"> <select name="tradition" id="select30">
                <option selected>--Select--</option>
          ...
          <tr>
            <td colspan="6"><input name="concept" type="text" value="Short, short, concept." size="40" maxlength="40"></td>
          </tr>
          <tr>
            <td colspan="6">Faction:</td>
          </tr>
          <tr> 
            <td colspan="6"> <div align="left">
              <input name="faction" type="text" id="faction" value="This box does not save.">
            </div></td>
          </tr>
          <tr> 
...
Yes! </td>
          ...
          <tr> 
            <td colspan="2"> <input name="essence" type="text" id="essence" size="15"></td>
          ...
          <tr> 
            ...
            <td width="11%"><select name="cha" id="select62">
                <option value="0">0</option>
                <option value="1" selected>1</option>
                <option value="2">2</option>
                <option value="3">3</option>
          ...
          <tr>
            ...
            <td>Cosmology:</td>
            <td><select name="cosmology" id="select28">
                <option value="0" selected>0</option>
                <option value="1">1</option>
                <option value="2">2</option>
                <option value="3">3</option>
          ...
          <tr> 
            ...
            <td>&nbsp;</td>
            <td>Technology:</td>
            <td><select name="technology" id="select12">
                <option value="0" selected>0</option>
                <option value="1">1</option>
                <option value="2">2</option>
                <option value="3">3</option>
            ...
            <td>Enigmas:</td>
            <td><select name="enigmas" id="select13">
                <option value="0" selected>0</option>
                <option value="1">1</option>
                <option value="2">2</option>
                <option value="3">3</option>
          ...
          <tr> 
            <td> <input name="supernat7" type="text" id="supernat7" size="15"></td>
            ...
            <td><input name="supernat8" type="text" id="supernat8" size="15"></td>
            ...
            <td><input name="supernat9" type="text" id="supernat9" size="15"></td>
          ...
          <tr> 
            <td colspan="6"><table width="100%" border="0" align="center">
                <tr> 
                  <td>Dynamic</td>
                  <td><select name="resdynamic" id="select84">
                  ...
                  <td>Entropic</td>
                  <td><select name="resentropic" id="select85">
                      <option value="0" selected>0</option>
                      <option value="1">1</option>
                      <option value="2">2</option>
                      <option value="3">3</option>
                  ...
                  <td>Static</td>
                  <td><select name="resstatic" id="select86">
                      <option value="0" selected>0</option>
                      <option value="1">1</option>
                      <option value="2">2</option>
                      <option value="3">3</option>
          ...
          <tr> 
            <td colspan="6"><div align="center"> 
                <input type="submit" name="Submit" value="Submit new Mage Character">
              </div></td>
          </tr>
        </table>
    </form><?php
