...
<input name="venue" type="hidden" value="Mage">
...
<table width="100%">
  ...
  <tr>
    <td colspan="2">
      <input name="charname" type="text" value="<?php echo $charname; ?>" id="charname3" size="25"></td>
    <td colspan="4">
      <input name="charage" type="text" value="<?php echo $charage; ?>" id="charage3" size="5"></td>
  </tr>
  <tr>
    <td colspan="2">Character Gender:</td>
    <td colspan="4">Tradition:
      <select name="tradition" id="select34">
        <option value="<?php echo $tradition; ?>" selected><?php echo $tradition; ?></option>
        <option value="Akashic Brotherhood">Akashic Brotherhood</option>
  ...
  <tr>
    <td colspan="2">
      <select name="charsex" id="select165">
...
<?php } ?>
  ...
  <tr>
    <td colspan="2"><p>
        <input name="nature" type="text" value="<?php echo $nature; ?>" id="nature3">
    </p></td>
    <td colspan="4">
      <input name="demeanor" type="text" value="<?php echo $demeanor; ?>" id="demeanor3"></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="6"><div align="left">
        <textarea name="description" cols="60" id="textarea4"><?php echo $description; ?></textarea>
</div></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="6">
      <input name="exitmsg" type="text" value="<?php echo $exitmsg; ?>" id="exitmsg2" size="60">
    </td>
  </tr>
  <tr>
    <td colspan="2">Essence</td>
    <td colspan="4">&nbsp;</td>
  </tr>
  <tr>
    <td colspan="2">
      <input name="essence" type="text" value="<?php echo $essence; ?>" id="essence" size="15"></td>
    <td colspan="4">
      <div align="left"></div></td>
  </tr>
  <tr>
    ...
    <td><?php
		...
		?>
		<input name="experience4" type="hidden" id="experience4" value="<?php echo $experience; ?>">
  ...
  <tr>
    <td>Awareness:</td>
    <td><select name="awareness" id="awareness">
	<option value="<?php echo $awareness; ?>" selected><?php echo $awareness; ?></option>
        <option value="0">0</option>
        <option value="1">1</option>
        <option value="2">2</option>
        <option value="3">3</option>
    ...
    <td>Meditation:</td>
    <td><select name="meditation" id="meditation">
	<option value="<?php echo $meditation; ?>" selected><?php echo $meditation; ?></option>
        <option value="0">0</option>
        <option value="1">1</option>
        <option value="2">2</option>
        <option value="3">3</option>
    ...
    <td>Cosmology:</td>
    <td><select name="cosmology" id="select205">
	<option value="<?php echo $cosmology; ?>" selected><?php echo $cosmology; ?></option>
        <option value="0">0</option>
        <option value="1">1</option>
        <option value="2">2</option>
        <option value="3">3</option>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td>Technology:</td>
    <td><select name="technology" id="select206">
    ...
    <td>Enigmas:</td>
    <td><select name="enigmas" id="select207">
  ...
  <tr>
    <td colspan="6"><input name="specialties" type="text" value="<?php echo $specialties; ?>" id="specialties2" size="93"></td>
  </tr>
  <tr>
    <td colspan="6">&nbsp;</td>
  </tr>
  ...
  <tr>
    ...
    <td colspan="2"><input name="meritstotal" type="text" value="<?php echo $meritstotal; ?>" id="meritstotal3" size="5"></td>
  </tr>
  <tr>
    <td colspan="6"><input name="merits" type="text" value="<?php echo $merits; ?>" id="merits23" size="93"></td>
  </tr>
  <tr>
    <td colspan="2">Flaws: </td>
    <td colspan="2">Total:</td>
    <td colspan="2"><input name="flawstotal" type="text" value="<?php echo $flawstotal; ?>" id="flawstotal3" size="5"></td>
  </tr>
  <tr>
    <td colspan="6">
      <input name="flaws" type="text" value="<?php echo $flaws; ?>" id="flaws23" size="93"></td>
  </tr>
  <tr>
    <td colspan="2">&nbsp;</td>
    <td colspan="2">&nbsp;</td>
  ...
  <tr>
    <td colspan="2">Arete:
        <select name="arete" id="select244">
			<option value="<?php echo $arete; ?>"><?php echo $arete; ?></option>
          <option value="1">1</option>
          <option value="2">2</option>
          <option value="3">3</option>
          <option value="4">4</option>
    ...
    <td colspan="4">Paradox:
        <select name="paradox" id="paradox">
		<option value="<?php echo $paradox; ?>"><?php echo $paradox; ?></option>
          <option value="0">0</option>
          <option value="1">1</option>
          <option value="2">2</option>
          <option value="3">3</option>
...
<option value="20">20</option>
  ...
  <tr>
    <td colspan="2">&nbsp; </td>
    <td colspan="4">Quintessence:
        <select name="quintessence" id="quintessence">
		<option value="<?php echo $quintessence; ?>"><?php echo $quintessence; ?></option>
          <option value="0">0</option>
          <option value="1">1</option>
          <option value="2">2</option>
          <option value="3">3</option>
...
<option value="20">20</option>
  ...
  <tr>
    <td colspan="2">
      <select name="willpowerperm" id="select245">
    ...
    <td colspan="4">
      <select name="willpowertemp" id="select246">
  ...
  <tr>
    <td colspan="6"><input name="equipment" type="text" value="<?php echo $equipment; ?>" id="equipment3" size="93"></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="6">
      <input name="misc" type="text" value="<?php echo $misc; ?>" id="misc3" size="93"></td>
  </tr>
  <tr>
    <td colspan="3"><div align="center">
        <input type="submit" name="Submit3" value="Update Mage">
    </div></td>
