...
// Check for required fields.
    ...
    $query="INSERT INTO characters (charname, playerid, player, venue) VALUES ('$_POST[charname]','$uid','$username','Changeling')";
  ...
  WHERE charname = '$_POST[charname]'"; 
	...
	// echo "Characer created";
	// $_SESSION[error] = "You have created a Changeling Character. Please check your character list";
