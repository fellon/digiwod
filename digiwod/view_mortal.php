...
<table width="100%" border="1" align="center">
          ...
          <tr> 
            <td colspan="2"><?php echo $charsex; ?></td>
            <td colspan="4">&nbsp; </td>
          </tr>
          <tr> 
          ...
          <tr> 
            <td colspan="2"> 
                <?php echo $nature; ?></td>
            <td colspan="4"><?php echo $demeanor; ?></td>
          </tr>
          <tr> 
            <td colspan="6">&nbsp; 
            </td>
...
&nbsp;</td>
          ...
          <tr> 
            <td colspan="6"><table width="100%" border="0" align="center">
                <tr> 
                  ...
                  <td><em><strong>Self-Control/Instinct:</strong></em></td>
          ...
          <tr> 
            <td colspan="2"><em><strong>Humanity/Path:</strong></em></td>
            <td colspan="4"><em><strong>Path Rating: </strong></em></td>
          </tr>
          <tr> 
            <td colspan="2"><?php echo $path; ?></td>
            <td colspan="4"><?php echo $pathrate; ?></td>
          </tr>
          <tr> 
          ...
          <tr> 
            <td colspan="2"><?php echo $willpowerperm; ?></td>
            <td colspan="4"><?php echo $willpowertemp; ?></td>
          </tr>
          <tr> 
